...
(function () {
    ...
    async function searchProducts(query) {
        ...
        try {
            ...
            // 6. Без try/catch любая сетевая ошибка (сервер недоступен, обрыв
            // соединения) привела бы к необработанному отклонённому промису —
            // пользователь остался бы смотреть на спиннер навсегда.
